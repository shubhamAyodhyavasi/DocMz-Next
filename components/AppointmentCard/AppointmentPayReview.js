...
class AppointmentPayReview extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
      ...
      success: false,
      today: "",
      durationdata: props.firstFormData.duration || "",
  ...
  handleSubmit = e => {
    ...
    let body = {
      ...
      patient: this.props.patient._id, //localStorage.getItem("patientid"),
      doctor: this.props.doctorId, //localStorage.getItem("doctorid"),
    ...
    console.log(
      ...
      this.state.formatnewdatestate,
      " at ",
      this.state.formattimestate
    );
    axios
      .post("http://localhost:3001/appointment/book", body)
      .then(response => {
  ...
  render() {
        ...
        <div className="d-flex flex-column h-100">
          <Row>
            <Col span={12}>
              ...
              <div classame="review-custom-section-ap__visit-details">
                ...
                <p>
                  ...
                  {this.state.durationdata || "No Duration Data Given"}
                </p>
                <p>
                  <strong>Consultation Cost : </strong>
                  {localStorage.getItem("doctorfee")}
                </p>
                <p>
            ...
            <Col span={12}>
              ...
              <p>Visa ending in : {this.props.selectedCard?.last4}</p>
            ...
            <div className="review-custom-section-ap__checkbox-ap">
              <Col span={24}>
                ...
                >
                  ...
                  <span onClick={this.showModal} style={{ color: "#82bbe9" }}>
                    Doc Mz's Informed Consent
                  </span>
                  .
                </Checkbox>
                ...
                >
                  I have read{" "}
                  <span onClick={this.showModal2} style={{ color: "#82bbe9" }}>
                    Doc Mz's Informed Consent
                  </span>{" "}
                  and I acknowledge that I have the ability to print a hard copy
                  of Privacy Policy for my records.
                </Checkbox>
              </Col>
    ...
    return (
      <div className="review-custom-section-ap">{appointmentdataholder}</div>

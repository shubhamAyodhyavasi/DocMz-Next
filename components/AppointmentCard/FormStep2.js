...
import { Form, Icon, Input, Row, Col, Divider, Radio, Tooltip } from "antd";
...
class FormStep2 extends Component {
  ...
  render() {
    ...
    let patientInfo = this.props.loggedInPatient
    const { getFieldDecorator } = this.props.form;
    const { phone } = patientInfo;
    return (
      <>
        <div className="second-step-custom-ap">
          <Row>
            <Col span={24}>
              <h2>
                Hey{patientInfo.name ? ` ${patientInfo.name}` : ""}, Let's get
                you taken care of
              </h2>
            </Col>
          </Row>
          <Row>
            <Col span={24} style={{ textAlign: "center" }}>
              <p className="visit-type-para-ap">
                Which type of visit would you like?
              </p>
            </Col>
            ...
            <Col span={24}>
              <center>
                <Radio.Group
                  className="second-step-custom-ap__radio-group"
                ...
                >
                  <Radio value="phone">
                    <Icon
                      type="phone"
                      value="phone"
                      className={classNames("second-step-custom-ap__icons", {
                        "second-step-custom-ap__icons--active":
          ...
          <Row>
            ...
            <Col
              ...
              className="second-step-custom-ap__numbercolsecondform"
            >
              <p className="visit-type-para-ap">
                What's the best number to reach you during your visit?
              </p>
              <Form.Item>
              ...
              <Tooltip
                title="We may reach out if there are changes to your visit."
                className="second-step-custom-ap__iconhelptooltip"
              >
                <Icon
                  type="question-circle"
                  className="second-step-custom-ap__iconhelp"
                />
              </Tooltip>
            </Col>
            {/* <Col span={12} >
